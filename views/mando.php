        ...
        <div class="contenedor_mando">
            ...
            <div class="termo">
                ...
                <div class="botones_termo">
                    <button type="button" class="btn_pulsado pulsacion on_termo" id="termo_on" onclick="termo(1)">On</button>
                    <button type="button" class="btn_pulsado pulsacion auto_termo" id="termo_auto" onclick="termo(2)">Auto</button>
                    <button type="button" class="btn_pulsado pulsacion off_termo" id="termo_off" onclick="termo(0)">Off</button>
                </div>
            </div>
        </div>
    </div>